...
main_frame.place(relx=0.5, rely=0, relwidth=0.90, relheight=0.1, anchor='n')
...
def show(file_name):
    print("show fun started ", file_name)
...
def enhanceColorImage():
    global file_name
    print("start enhanceColorImage")
    
    new_file_name = Code.enhanceColorImage(file_name)
    print("stop enhanceColorImage")
    
    print("showing ", new_file_name)
...
output_img1 = tk.Button(frame, text='Enhance', command=lambda: enhanceColorImage(
), bg="yellow", font=('calibri', 20, 'bold'))
...
lower_frame.place(relx=0.3, rely=0.3, relwidth=0.30, relheight=0.6, anchor='n')
bg_color = 'white'
...
output1 = tk.Canvas(lower_frame1, bg=bg_color1, bd=10, highlightthickness=0)
